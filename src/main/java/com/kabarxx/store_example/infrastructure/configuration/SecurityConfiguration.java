...
import com.kabarxx.store_example.application.jwt.JwtAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    @Autowired
    public SecurityConfiguration(JwtAuthenticationFilter jwtAuthenticationFilter, UserDomainService userService) {
